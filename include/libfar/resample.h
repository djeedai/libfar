...
void FAR_API FAR_FN(upsample2f32)(const char* FAR_RESTRICT buf_in,
                                  size_t size_in,
                                  int sample_rate,
                                  int num_channels,
...
/// for float32 values in [-1:1].
void FAR_API FAR_FN(upsample3f32)(const char* FAR_RESTRICT buf_in,
                                  size_t size_in,
                                  int sample_rate,
                                  int num_channels,
                                  char* FAR_RESTRICT buf_out,
...
/// for float32 values in [-1:1].
void FAR_API FAR_FN(downsample2f32)(const char* FAR_RESTRICT buf_in,
                                    size_t size_in,
                                    int sample_rate,
                                    int num_channels,
                                    char* FAR_RESTRICT buf_out,
...
/// for float32 values in [-1:1].
void FAR_API FAR_FN(downsample3f32)(const char* FAR_RESTRICT buf_in,
                                    size_t size_in,
                                    int sample_rate,
                                    int num_channels,
                                    char* FAR_RESTRICT buf_out,
